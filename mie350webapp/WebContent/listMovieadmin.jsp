			...
			<div class="col-sm-8 text-left">
				...
				<a class="btn btn-primary" href="StudentController?action=insert">Add
					A New Student</a> <br /> <br /> The following <B><c:out
						value="${movies.size()}" /> students</B> are in your database (you can click on the table headings to sort the students): <br>
				<br>
				<table border=1 class="sortable">
					...
					<tbody>
						<c:forEach items="${students}" var="student">
							<tr>
								<td align="center"><c:out value="${movies.getMovieid()}" /></td>
								<td align="center"><c:out value="${student.getMovieTitle()}" /></td>
								<td align="center"><c:out value="${student.getGenre()}" /></td>
